...
const moods: ImageMood[] = ["Hyperrealism", "Anime", "Pixel Art", "Portrait", "Artistic", "Minimal", "Random"]

export function ImageMoodSelector({ selectedMood, onSelectMood }: ImageMoodSelectorProps) {
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2 shadow-none">
        {moods.map((mood) => (
          <Button
            ...
            className="rounded-full shadow-none font-normal border"
          >
            {mood}
          </Button>
        ))}
